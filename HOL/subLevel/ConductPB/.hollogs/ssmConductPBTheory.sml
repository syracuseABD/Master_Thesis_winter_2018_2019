...
<<HOL message: Created theory "ssmConductPB">>
...
<<HOL warning: GrammarDeltas.revise_data: 
  Grammar-deltas:
    overload_on("conductPBNS_tupled")
  invalidated by DelConstant(ssmConductPB$conductPBNS_tupled)>>
Saved definition __ "conductPBNS_def"
Saved induction ___ "conductPBNS_ind"
<<HOL message: mk_functional: 
  pattern completion has added 11 clauses to the original specification.>>
<<HOL warning: GrammarDeltas.revise_data: 
  Grammar-deltas:
    overload_on("conductPBOut_tupled")
  invalidated by DelConstant(ssmConductPB$conductPBOut_tupled)>>
Saved definition __ "conductPBOut_def"
Saved induction ___ "conductPBOut_ind"
<<HOL message: mk_functional: 
  pattern completion has added 37 clauses to the original specification.>>
Saved definition __ "authTestConductPB_def"
Saved induction ___ "authTestConductPB_ind"
Saved definition __ "ssmConductPBStateInterp_def"
Saved theorem _____ "authTestConductPB_cmd_reject_lemma"
Saved definition __ "secContextConductPB_def"
Saved theorem _____ "PlatoonLeader_plCommandPB_lemma"
Saved theorem _____ "PlatoonLeader_exec_plCommandPB_justified_thm"
Saved theorem _____ "PlatoonSergeant_psgCommandPB_lemma"
Saved theorem _____ "PlatoonSergeant_exec_psgCommandPB_justified_thm"
Exporting theory "ssmConductPB" ... done.
Theory "ssmConductPB" took 1.7s to build
Completed load of ssmConductPBScript

...
<<HOL message: Created theory "ssmConductORP">>
<<HOL message: mk_functional: 
  pattern completion has added 11 clauses to the original specification.>>
<<HOL warning: GrammarDeltas.revise_data: 
  Grammar-deltas:
    overload_on("conductORPNS_tupled")
  invalidated by DelConstant(ssmConductORP$conductORPNS_tupled)>>
Saved definition __ "conductORPNS_def"
Saved induction ___ "conductORPNS_ind"
<<HOL message: mk_functional: 
  pattern completion has added 11 clauses to the original specification.>>
<<HOL warning: GrammarDeltas.revise_data: 
  Grammar-deltas:
    overload_on("conductORPOut_tupled")
  invalidated by DelConstant(ssmConductORP$conductORPOut_tupled)>>
Saved definition __ "conductORPOut_def"
Saved induction ___ "conductORPOut_ind"
<<HOL message: mk_functional: 
  pattern completion has added 37 clauses to the original specification.>>
Saved definition __ "authTestConductORP_def"
Saved induction ___ "authTestConductORP_ind"
Saved definition __ "ssmConductORPStateInterp_def"
Saved theorem _____ "authTestConductORP_cmd_reject_lemma"
Saved definition __ "secContextConductORP_def"
Saved theorem _____ "PlatoonLeader_plCommand_lemma"
Saved theorem _____ "PlatoonLeader_exec_plCommand_justified_thm"
Saved theorem _____ "PlatoonSergeant_psgCommand_lemma"
Saved theorem _____ "PlatoonSergeant_exec_psgCommand_justified_thm"
Exporting theory "ssmConductORP" ... done.
Theory "ssmConductORP" took 1.7s to build
Completed load of ssmConductORPScript

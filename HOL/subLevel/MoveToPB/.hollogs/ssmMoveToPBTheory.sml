...
<<HOL message: Created theory "ssmMoveToPB">>
...
<<HOL warning: GrammarDeltas.revise_data: 
  Grammar-deltas:
    overload_on("moveToPBNS_tupled")
  invalidated by DelConstant(ssmMoveToPB$moveToPBNS_tupled)>>
Saved definition __ "moveToPBNS_def"
Saved induction ___ "moveToPBNS_ind"
<<HOL message: mk_functional: 
  pattern completion has added 19 clauses to the original specification.>>
<<HOL warning: GrammarDeltas.revise_data: 
  Grammar-deltas:
    overload_on("moveToPBOut_tupled")
  invalidated by DelConstant(ssmMoveToPB$moveToPBOut_tupled)>>
Saved definition __ "moveToPBOut_def"
Saved induction ___ "moveToPBOut_ind"
<<HOL message: mk_functional: 
  pattern completion has added 37 clauses to the original specification.>>
Saved definition __ "authTestMoveToPB_def"
Saved induction ___ "authTestMoveToPB_ind"
Saved definition __ "ssmMoveToPBStateInterp_def"
Saved theorem _____ "authTestMoveToPB_cmd_reject_lemma"
Saved definition __ "secContextMoveToPB_def"
Saved theorem _____ "PlatoonLeader_slCommand_lemma"
Saved theorem _____ "PlatoonLeader_exec_slCommand_justified_thm"
Exporting theory "ssmMoveToPB" ... done.
Theory "ssmMoveToPB" took 2.0s to build
Completed load of ssmMoveToPBScript

...
sig
  ...
  val MoveToPBType_grammars : type_grammar.grammar * term_grammar.grammar
(*
   [indexedLists] Parent theory of "MoveToPBType"

   [patternMatches] Parent theory of "MoveToPBType"
   ...
   [datatype_slCommand]  Theorem
      ...
      |- DATATYPE (slCommand pltForm pltMove pltHalt complete incomplete)

   [datatype_slOutput]  Theorem

      |- DATATYPE
           (slOutput MoveToPB PLTForm PLTMove PLTHalt Complete unAuthorized
              unAuthenticated)

   [datatype_slState]  Theorem

      |- DATATYPE (slState MOVE_TO_PB PLT_FORM PLT_MOVE PLT_HALT COMPLETE)
   ...
   [num2slCommand_thm]  Theorem
      ...
      |- (num2slCommand 0 = pltForm) ∧ (num2slCommand 1 = pltMove) ∧
         (num2slCommand 2 = pltHalt) ∧ (num2slCommand 3 = complete) ∧
   ...
   [num2slOutput_thm]  Theorem
      ...
      |- (num2slOutput 0 = MoveToPB) ∧ (num2slOutput 1 = PLTForm) ∧
         (num2slOutput 2 = PLTMove) ∧ (num2slOutput 3 = PLTHalt) ∧
   ...
   [num2slState_thm]  Theorem
      ...
      |- (num2slState 0 = MOVE_TO_PB) ∧ (num2slState 1 = PLT_FORM) ∧
         (num2slState 2 = PLT_MOVE) ∧ (num2slState 3 = PLT_HALT) ∧
   ...
   [slCommand2num_thm]  Theorem
      ...
      |- (slCommand2num pltForm = 0) ∧ (slCommand2num pltMove = 1) ∧
         (slCommand2num pltHalt = 2) ∧ (slCommand2num complete = 3) ∧
   ...
   [slCommand_Axiom]  Theorem
      ...
      |- ∀x0 x1 x2 x3 x4.
           ∃f.
             (f pltForm = x0) ∧ (f pltMove = x1) ∧ (f pltHalt = x2) ∧
   ...
   [slCommand_case_cong]  Theorem
      ...
      |- ∀M M' v0 v1 v2 v3 v4.
           (M = M') ∧ ((M' = pltForm) ⇒ (v0 = v0')) ∧
           ((M' = pltMove) ⇒ (v1 = v1')) ∧ ((M' = pltHalt) ⇒ (v2 = v2')) ∧
           ((M' = complete) ⇒ (v3 = v3')) ∧
           ((M' = incomplete) ⇒ (v4 = v4')) ⇒
           ((case M of
               pltForm => v0
   ...
   [slCommand_distinct]  Theorem
      ...
      |- pltForm ≠ pltMove ∧ pltForm ≠ pltHalt ∧ pltForm ≠ complete ∧
         pltForm ≠ incomplete ∧ pltMove ≠ pltHalt ∧ pltMove ≠ complete ∧
         pltMove ≠ incomplete ∧ pltHalt ≠ complete ∧ pltHalt ≠ incomplete ∧
         complete ≠ incomplete
   ...
   [slCommand_induction]  Theorem
      ...
      |- ∀P.
           P complete ∧ P incomplete ∧ P pltForm ∧ P pltHalt ∧ P pltMove ⇒
           ∀a. P a

   [slCommand_nchotomy]  Theorem

      |- ∀a.
           (a = pltForm) ∨ (a = pltMove) ∨ (a = pltHalt) ∨ (a = complete) ∨
           (a = incomplete)
   ...
   [slOutput2num_thm]  Theorem
      ...
      |- (slOutput2num MoveToPB = 0) ∧ (slOutput2num PLTForm = 1) ∧
         (slOutput2num PLTMove = 2) ∧ (slOutput2num PLTHalt = 3) ∧
   ...
   [slOutput_Axiom]  Theorem
      ...
      |- ∀x0 x1 x2 x3 x4 x5 x6.
           ∃f.
             (f MoveToPB = x0) ∧ (f PLTForm = x1) ∧ (f PLTMove = x2) ∧
             (f PLTHalt = x3) ∧ (f Complete = x4) ∧ (f unAuthorized = x5) ∧
             (f unAuthenticated = x6)
   ...
   [slOutput_case_cong]  Theorem
      ...
      |- ∀M M' v0 v1 v2 v3 v4 v5 v6.
           (M = M') ∧ ((M' = MoveToPB) ⇒ (v0 = v0')) ∧
           ((M' = PLTForm) ⇒ (v1 = v1')) ∧ ((M' = PLTMove) ⇒ (v2 = v2')) ∧
           ((M' = PLTHalt) ⇒ (v3 = v3')) ∧ ((M' = Complete) ⇒ (v4 = v4')) ∧
   ...
   [slOutput_distinct]  Theorem
      ...
      |- MoveToPB ≠ PLTForm ∧ MoveToPB ≠ PLTMove ∧ MoveToPB ≠ PLTHalt ∧
         MoveToPB ≠ Complete ∧ MoveToPB ≠ unAuthorized ∧
         MoveToPB ≠ unAuthenticated ∧ PLTForm ≠ PLTMove ∧
         PLTForm ≠ PLTHalt ∧ PLTForm ≠ Complete ∧ PLTForm ≠ unAuthorized ∧
         PLTForm ≠ unAuthenticated ∧ PLTMove ≠ PLTHalt ∧
         PLTMove ≠ Complete ∧ PLTMove ≠ unAuthorized ∧
         PLTMove ≠ unAuthenticated ∧ PLTHalt ≠ Complete ∧
         PLTHalt ≠ unAuthorized ∧ PLTHalt ≠ unAuthenticated ∧
         Complete ≠ unAuthorized ∧ Complete ≠ unAuthenticated ∧
   ...
   [slOutput_induction]  Theorem
      ...
      |- ∀P.
           P Complete ∧ P MoveToPB ∧ P PLTForm ∧ P PLTHalt ∧ P PLTMove ∧
   ...
   [slOutput_nchotomy]  Theorem
      ...
      |- ∀a.
           (a = MoveToPB) ∨ (a = PLTForm) ∨ (a = PLTMove) ∨ (a = PLTHalt) ∨
           (a = Complete) ∨ (a = unAuthorized) ∨ (a = unAuthenticated)
   ...
   [slState2num_thm]  Theorem
      ...
      |- (slState2num MOVE_TO_PB = 0) ∧ (slState2num PLT_FORM = 1) ∧
         (slState2num PLT_MOVE = 2) ∧ (slState2num PLT_HALT = 3) ∧
   ...
   [slState_Axiom]  Theorem
      ...
      |- ∀x0 x1 x2 x3 x4.
           ∃f.
             (f MOVE_TO_PB = x0) ∧ (f PLT_FORM = x1) ∧ (f PLT_MOVE = x2) ∧
             (f PLT_HALT = x3) ∧ (f COMPLETE = x4)
   ...
   [slState_distinct]  Theorem
      ...
      |- MOVE_TO_PB ≠ PLT_FORM ∧ MOVE_TO_PB ≠ PLT_MOVE ∧
         ...
         PLT_FORM ≠ PLT_MOVE ∧ PLT_FORM ≠ PLT_HALT ∧ PLT_FORM ≠ COMPLETE ∧
         PLT_MOVE ≠ PLT_HALT ∧ PLT_MOVE ≠ COMPLETE ∧ PLT_HALT ≠ COMPLETE
   ...
   [slState_induction]  Theorem
      ...
      |- ∀P.
           P COMPLETE ∧ P MOVE_TO_PB ∧ P PLT_FORM ∧ P PLT_HALT ∧
           P PLT_MOVE ⇒
           ∀a. P a
   ...
   [slState_nchotomy]  Theorem
      ...
      |- ∀a.
           (a = MOVE_TO_PB) ∨ (a = PLT_FORM) ∨ (a = PLT_MOVE) ∨
           (a = PLT_HALT) ∨ (a = COMPLETE)

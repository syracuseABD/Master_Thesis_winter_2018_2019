...
<<HOL message: Created theory "ssmPlanPB">>
...
<<HOL warning: GrammarDeltas.revise_data: 
  Grammar-deltas:
    overload_on("planPBNS_tupled")
  invalidated by DelConstant(ssmPlanPB$planPBNS_tupled)>>
Saved definition __ "planPBNS_def"
Saved induction ___ "planPBNS_ind"
<<HOL message: mk_functional: 
  pattern completion has added 4 clauses to the original specification.>>
<<HOL warning: GrammarDeltas.revise_data: 
  Grammar-deltas:
    overload_on("planPBOut_tupled")
  invalidated by DelConstant(ssmPlanPB$planPBOut_tupled)>>
Saved definition __ "planPBOut_def"
Saved induction ___ "planPBOut_ind"
<<HOL message: mk_functional: 
  pattern completion has added 37 clauses to the original specification.>>
Saved definition __ "inputOK_def"
Saved induction ___ "inputOK_ind"
Saved theorem _____ "PlatoonLeader_notWARNO_notreport1_exec_plCommand_lemma"
Saved theorem _____ "PlatoonLeader_notWARNO_notreport1_exec_plCommand_justified_lemma"
Saved theorem _____ "PlatoonLeader_notWARNO_notreport1_exec_plCommand_justified_thm"
Saved theorem _____ "PlatoonLeader_WARNO_exec_report1_lemma"
Saved theorem _____ "PlatoonLeader_WARNO_exec_report1_justified_lemma"
Saved theorem _____ "PlatoonLeader_WARNO_exec_report1_justified_thm"
Saved theorem _____ "PlatoonLeader_psgCommand_notDiscard_thm"
Saved theorem _____ "PlatoonLeader_trap_psgCommand_lemma"
Saved theorem _____ "PlatoonLeader_trap_psgCommand_justified_lemma"
Saved theorem _____ "PlatoonLeader_trap_psgCommand_justified_lemma"
Saved theorem _____ "PlatoonSergeant_trap_plCommand_lemma"
Saved theorem _____ "PlatoonSergeant_trap_plCommand_justified_lemma"
Saved theorem _____ "PlatoonSergeant_trap_plCommand_justified_thm"
Exporting theory "ssmPlanPB" ... done.
Theory "ssmPlanPB" took 23.6s to build
Completed load of ssmPlanPBScript

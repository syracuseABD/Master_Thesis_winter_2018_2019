...
<<HOL message: Created theory "ssmMoveToORP">>
...
<<HOL warning: GrammarDeltas.revise_data: 
  Grammar-deltas:
    overload_on("moveToORPNS_tupled")
  invalidated by DelConstant(ssmMoveToORP$moveToORPNS_tupled)>>
Saved definition __ "moveToORPNS_def"
Saved induction ___ "moveToORPNS_ind"
<<HOL message: mk_functional: 
  pattern completion has added 19 clauses to the original specification.>>
<<HOL warning: GrammarDeltas.revise_data: 
  Grammar-deltas:
    overload_on("moveToORPOut_tupled")
  invalidated by DelConstant(ssmMoveToORP$moveToORPOut_tupled)>>
Saved definition __ "moveToORPOut_def"
Saved induction ___ "moveToORPOut_ind"
<<HOL message: mk_functional: 
  pattern completion has added 37 clauses to the original specification.>>
Saved definition __ "authTestMoveToORP_def"
Saved induction ___ "authTestMoveToORP_ind"
Saved definition __ "ssmMoveToORPStateInterp_def"
Saved theorem _____ "authTestMoveToORP_cmd_reject_lemma"
Saved definition __ "secContextMoveToORP_def"
Saved theorem _____ "PlatoonLeader_slCommand_lemma"
Saved theorem _____ "PlatoonLeader_exec_slCommand_justified_thm"
Exporting theory "ssmMoveToORP" ... done.
Theory "ssmMoveToORP" took 1.5s to build
Completed load of ssmMoveToORPScript

...
(*
   ...
   [datatype_slOutput]  Theorem
      ...
      |- DATATYPE
           (slOutput MoveToORP PLTForm PLTMove PLTSecureHalt Complete
              unAuthorized unAuthenticated)

   [datatype_slState]  Theorem

      |- DATATYPE
           (slState MOVE_TO_ORP PLT_FORM PLT_MOVE PLT_SECURE_HALT COMPLETE)
   ...
   [num2slOutput_thm]  Theorem
      ...
      |- (num2slOutput 0 = MoveToORP) ∧ (num2slOutput 1 = PLTForm) ∧
   ...
   [num2slState_thm]  Theorem
      ...
      |- (num2slState 0 = MOVE_TO_ORP) ∧ (num2slState 1 = PLT_FORM) ∧
   ...
   [slOutput2num_thm]  Theorem
      ...
      |- (slOutput2num MoveToORP = 0) ∧ (slOutput2num PLTForm = 1) ∧
   ...
   [slOutput_Axiom]  Theorem
      ...
      |- ∀x0 x1 x2 x3 x4 x5 x6.
           ∃f.
             (f MoveToORP = x0) ∧ (f PLTForm = x1) ∧ (f PLTMove = x2) ∧
   ...
   [slOutput_induction]  Theorem
      ...
      |- ∀P.
           P Complete ∧ P MoveToORP ∧ P PLTForm ∧ P PLTMove ∧
   ...
   [slOutput_nchotomy]  Theorem
      ...
      |- ∀a.
           (a = MoveToORP) ∨ (a = PLTForm) ∨ (a = PLTMove) ∨
   ...
   [slState2num_thm]  Theorem
      ...
      |- (slState2num MOVE_TO_ORP = 0) ∧ (slState2num PLT_FORM = 1) ∧
   ...
   [slState_Axiom]  Theorem
      ...
      |- ∀x0 x1 x2 x3 x4.
           ∃f.
             (f MOVE_TO_ORP = x0) ∧ (f PLT_FORM = x1) ∧ (f PLT_MOVE = x2) ∧
   ...
   [slState_induction]  Theorem
      ...
      |- ∀P.
           P COMPLETE ∧ P MOVE_TO_ORP ∧ P PLT_FORM ∧ P PLT_MOVE ∧
           P PLT_SECURE_HALT ⇒
           ∀a. P a
   ...
   [slState_nchotomy]  Theorem
      ...
      |- ∀a.
           (a = MOVE_TO_ORP) ∨ (a = PLT_FORM) ∨ (a = PLT_MOVE) ∨

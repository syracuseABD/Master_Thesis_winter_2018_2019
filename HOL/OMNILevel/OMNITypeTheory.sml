...
struct
  ...
  fun op command_TY_DEF x = x
    ...
    ThmBind.DT(((("OMNIType",25),[("bool",[26])]),["DISK_THM"]),
  ...
  fun op command_case_def x = x
    ...
    ThmBind.DT(((("OMNIType",31),
                [("OMNIType",[26,27,28,29,30]),("bool",[26,180]),

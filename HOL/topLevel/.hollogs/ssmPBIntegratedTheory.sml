...
<<HOL message: Created theory "ssmPBIntegrated">>
<<HOL message: mk_functional: 
  pattern completion has added 31 clauses to the original specification.>>
<<HOL warning: GrammarDeltas.revise_data: 
  Grammar-deltas:
    overload_on("PBNS_tupled")
  invalidated by DelConstant(ssmPBIntegrated$PBNS_tupled)>>
Saved definition __ "PBNS_def"
Saved induction ___ "PBNS_ind"
<<HOL message: mk_functional: 
  pattern completion has added 31 clauses to the original specification.>>
<<HOL warning: GrammarDeltas.revise_data: 
  Grammar-deltas:
    overload_on("PBOut_tupled")
  invalidated by DelConstant(ssmPBIntegrated$PBOut_tupled)>>
Saved definition __ "PBOut_def"
Saved induction ___ "PBOut_ind"
<<HOL message: mk_functional: 
...
Saved theorem _____ "PlatoonLeader_PLAN_PB_exec_lemma"
Saved theorem _____ "PlatoonLeader_PLAN_PB_trap_lemma"
Saved theorem _____ "PlatoonLeader_PLAN_PB_trap_justified_lemma"
Saved theorem _____ "PlatoonLeader_PLAN_PB_trap_justified_thm"
Saved theorem _____ "PlatoonLeader_Omni_notDiscard_slCommand_thm"
Exporting theory "ssmPBIntegrated" ... done.
Theory "ssmPBIntegrated" took 6.9s to build
Completed load of ssmPBIntegratedScript

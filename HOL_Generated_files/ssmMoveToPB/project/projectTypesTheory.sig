...
(*
   ...
   [platoonLeaderCom_CASE]  Definition
      ...
      |- ∀x v0 v1 v2.
           (case x of form => v0 | move => v1 | secureHalt => v2) =
   ...
   [state_BIJ]  Definition
      ...
      |- (∀a. num2state (state2num a) = a) ∧
         ∀r. (λn. n < 4) r ⇔ (state2num (num2state r) = r)
   ...
   [datatype_platoonLeaderCom]  Theorem
      ...
      |- DATATYPE (platoonLeaderCom form move secureHalt)
   ...
   [datatype_state]  Theorem
      ...
      |- DATATYPE (state MOVE_TO_PB FORM MOVE SECURE_HALT)
   ...
   [num2output_thm]  Theorem
      ...
      |- (num2output 0 = Move_to_ORP) ∧ (num2output 1 = Form) ∧
         (num2output 2 = Move) ∧ (num2output 3 = Secure_halt) ∧
   ...
   [num2platoonLeaderCom_thm]  Theorem
      ...
      |- (num2platoonLeaderCom 0 = form) ∧
         (num2platoonLeaderCom 1 = move) ∧
         (num2platoonLeaderCom 2 = secureHalt)
   ...
   [num2state_11]  Theorem
      ...
      |- ∀r r'. r < 4 ⇒ r' < 4 ⇒ ((num2state r = num2state r') ⇔ (r = r'))

   [num2state_ONTO]  Theorem

      |- ∀a. ∃r. (a = num2state r) ∧ r < 4
   ...
   [num2state_thm]  Theorem
      ...
      |- (num2state 0 = MOVE_TO_PB) ∧ (num2state 1 = FORM) ∧
         (num2state 2 = MOVE) ∧ (num2state 3 = SECURE_HALT)
   ...
   [output2num_thm]  Theorem
      ...
      |- (output2num Move_to_ORP = 0) ∧ (output2num Form = 1) ∧
         (output2num Move = 2) ∧ (output2num Secure_halt = 3) ∧
   ...
   [output_Axiom]  Theorem
      ...
      |- ∀x0 x1 x2 x3 x4 x5 x6.
           ∃f.
             (f Move_to_ORP = x0) ∧ (f Form = x1) ∧ (f Move = x2) ∧
             (f Secure_halt = x3) ∧ (f NoActionTaken = x4) ∧
   ...
   [output_distinct]  Theorem
      ...
      |- Move_to_ORP ≠ Form ∧ Move_to_ORP ≠ Move ∧
         Move_to_ORP ≠ Secure_halt ∧ Move_to_ORP ≠ NoActionTaken ∧
         Move_to_ORP ≠ UnAuthenticated ∧ Move_to_ORP ≠ UnAuthorized ∧
         Form ≠ Move ∧ Form ≠ Secure_halt ∧ Form ≠ NoActionTaken ∧
         Form ≠ UnAuthenticated ∧ Form ≠ UnAuthorized ∧
         Move ≠ Secure_halt ∧ Move ≠ NoActionTaken ∧
         Move ≠ UnAuthenticated ∧ Move ≠ UnAuthorized ∧
         Secure_halt ≠ NoActionTaken ∧ Secure_halt ≠ UnAuthenticated ∧
         Secure_halt ≠ UnAuthorized ∧ NoActionTaken ≠ UnAuthenticated ∧
   ...
   [output_induction]  Theorem
      ...
      |- ∀P.
           P Form ∧ P Move ∧ P Move_to_ORP ∧ P NoActionTaken ∧
   ...
   [output_nchotomy]  Theorem
      ...
      |- ∀a.
           (a = Move_to_ORP) ∨ (a = Form) ∨ (a = Move) ∨
           (a = Secure_halt) ∨ (a = NoActionTaken) ∨
   ...
   [platoonLeaderCom2num_thm]  Theorem
      ...
      |- (platoonLeaderCom2num form = 0) ∧
         (platoonLeaderCom2num move = 1) ∧
         (platoonLeaderCom2num secureHalt = 2)

   [platoonLeaderCom_Axiom]  Theorem

      |- ∀x0 x1 x2. ∃f. (f form = x0) ∧ (f move = x1) ∧ (f secureHalt = x2)
   ...
   [platoonLeaderCom_case_cong]  Theorem
      ...
      |- ∀M M' v0 v1 v2.
           (M = M') ∧ ((M' = form) ⇒ (v0 = v0')) ∧
           ((M' = move) ⇒ (v1 = v1')) ∧ ((M' = secureHalt) ⇒ (v2 = v2')) ⇒
           ((case M of form => v0 | move => v1 | secureHalt => v2) =
            case M' of form => v0' | move => v1' | secureHalt => v2')

   [platoonLeaderCom_case_def]  Theorem

      |- (∀v0 v1 v2.
            (case form of form => v0 | move => v1 | secureHalt => v2) =
            v0) ∧
         (∀v0 v1 v2.
            (case move of form => v0 | move => v1 | secureHalt => v2) =
            v1) ∧
         ∀v0 v1 v2.
           (case secureHalt of
              form => v0
   ...
   [platoonLeaderCom_distinct]  Theorem
      ...
      |- form ≠ move ∧ form ≠ secureHalt ∧ move ≠ secureHalt
   ...
   [platoonLeaderCom_induction]  Theorem
      ...
      |- ∀P. P form ∧ P move ∧ P secureHalt ⇒ ∀a. P a

   [platoonLeaderCom_nchotomy]  Theorem

      |- ∀a. (a = form) ∨ (a = move) ∨ (a = secureHalt)
   ...
   [state2num_ONTO]  Theorem
      ...
      |- ∀r. r < 4 ⇔ ∃a. r = state2num a

   [state2num_num2state]  Theorem

      |- ∀r. r < 4 ⇔ (state2num (num2state r) = r)

   [state2num_thm]  Theorem

      |- (state2num MOVE_TO_PB = 0) ∧ (state2num FORM = 1) ∧
         (state2num MOVE = 2) ∧ (state2num SECURE_HALT = 3)

   [state_Axiom]  Theorem

      |- ∀x0 x1 x2 x3.
           ∃f.
             (f MOVE_TO_PB = x0) ∧ (f FORM = x1) ∧ (f MOVE = x2) ∧
             (f SECURE_HALT = x3)
   ...
   [state_distinct]  Theorem
      ...
      |- MOVE_TO_PB ≠ FORM ∧ MOVE_TO_PB ≠ MOVE ∧ MOVE_TO_PB ≠ SECURE_HALT ∧
         FORM ≠ MOVE ∧ FORM ≠ SECURE_HALT ∧ MOVE ≠ SECURE_HALT
   ...
   [state_induction]  Theorem
      ...
      |- ∀P. P FORM ∧ P MOVE ∧ P MOVE_TO_PB ∧ P SECURE_HALT ⇒ ∀a. P a

   [state_nchotomy]  Theorem

      |- ∀a. (a = MOVE_TO_PB) ∨ (a = FORM) ∨ (a = MOVE) ∨ (a = SECURE_HALT)

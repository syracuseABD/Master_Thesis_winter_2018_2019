...
val _= Datatype `platoonLeaderCom
      ...
      | complete
`
val _= Datatype `platoonSergeantCom
      = actionsIn
      | psgNA
`
...
val platoonSergeantCom_distinct_clauses = distinct_of``:platoonSergeantCom``
val _= save_thm("platoonSergeantCom_distinct_clauses",

...
(*
         ...
         WFREC (@R. WF R)
           (λauthentication a.
              ...
              | Name PlatoonLeader says
                prop (SOME (PlatoonSergeantCOM x')) =>
                  I F
              | Name PlatoonSergeant says
                prop (SOME (PlatoonSergeantCOM x')) =>
                  I T
              | Name Omni says prop (SOME (PlatoonSergeantCOM x')) => I F
              | Name PlatoonLeader says prop (SOME (OmniCOM x'')) => I F
              | Name PlatoonSergeant says prop (SOME (OmniCOM x'')) => I F
   ...
   [authentication_def]  Theorem
      ...
      |- (authentication
         ...
         (authentication
            (Name PlatoonSergeant says
             prop (SOME (PlatoonSergeantCOM x'))) ⇔ T) ∧
         ...
         (authentication
            (Name PlatoonSergeant says
             prop (SOME (PlatoonLeaderCOM v144))) ⇔ F) ∧
         (authentication
            (Name Omni says prop (SOME (PlatoonLeaderCOM v144))) ⇔ F) ∧
         (authentication
            (Name PlatoonLeader says
             prop (SOME (PlatoonSergeantCOM v145))) ⇔ F) ∧
         (authentication
            (Name Omni says prop (SOME (PlatoonSergeantCOM v145))) ⇔ F) ∧
         (authentication
            (Name PlatoonLeader says prop (SOME (OmniCOM v146))) ⇔ F) ∧
         (authentication
            (Name PlatoonSergeant says prop (SOME (OmniCOM v146))) ⇔ F) ∧
   ...
   [authentication_ind]  Theorem
      ...
      |- ∀P.
           ...
           (∀v145.
              P
                (Name PlatoonLeader says
                 prop (SOME (PlatoonSergeantCOM v145)))) ∧
           (∀v145.
              P (Name Omni says prop (SOME (PlatoonSergeantCOM v145)))) ∧
           (∀v146.
              P (Name PlatoonLeader says prop (SOME (OmniCOM v146)))) ∧
           (∀v146.
              P (Name PlatoonSergeant says prop (SOME (OmniCOM v146)))) ∧

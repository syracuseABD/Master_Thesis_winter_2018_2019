...
<<HOL message: Created theory "projectUtilities">>
<<HOL message: mk_functional: 
  pattern completion has added 2 clauses to the original specification.>>
Saved definition __ "getPlatoonLeaderCOM_def"
Saved induction ___ "getPlatoonLeaderCOM_ind"
<<HOL message: mk_functional: 
  pattern completion has added 2 clauses to the original specification.>>
Saved definition __ "getPlatoonSergeantCOM_def"
Saved induction ___ "getPlatoonSergeantCOM_ind"
<<HOL message: mk_functional: 
  pattern completion has added 2 clauses to the original specification.>>
Saved definition __ "getOmniCOM_def"
Saved induction ___ "getOmniCOM_ind"
<<HOL message: mk_functional: 
  pattern completion has added 42 clauses to the original specification.>>
Saved definition __ "getPlatoonLeaderCOMx_def"
Saved induction ___ "getPlatoonLeaderCOMx_ind"
<<HOL message: mk_functional: 
  pattern completion has added 42 clauses to the original specification.>>
Saved definition __ "getPlatoonSergeantCOMx_def"
Saved induction ___ "getPlatoonSergeantCOMx_ind"
<<HOL message: mk_functional: 
  pattern completion has added 42 clauses to the original specification.>>
Saved definition __ "getOmniCOMx_def"
Saved induction ___ "getOmniCOMx_ind"
Exporting theory "projectUtilities" ... done.
Theory "projectUtilities" took 10.7s to build
Completed load of projectUtilitiesScript

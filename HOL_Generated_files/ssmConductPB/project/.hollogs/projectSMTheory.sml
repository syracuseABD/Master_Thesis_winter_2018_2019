...
<<HOL message: Created theory "projectSM">>
...
<<HOL warning: GrammarDeltas.revise_data: 
  Grammar-deltas:
    overload_on("NS_tupled")
  invalidated by DelConstant(projectSM$NS_tupled)>>
Saved definition __ "NS_def"
Saved induction ___ "NS_ind"
<<HOL message: mk_functional: 
  pattern completion has added 1 clause to the original specification.>>
<<HOL warning: GrammarDeltas.revise_data: 
  Grammar-deltas:
    overload_on("NOut_tupled")
  invalidated by DelConstant(projectSM$NOut_tupled)>>
Saved definition __ "NOut_def"
Saved induction ___ "NOut_ind"
Exporting theory "projectSM" ... done.
Theory "projectSM" took 0.44393s to build
Completed load of projectSMScript

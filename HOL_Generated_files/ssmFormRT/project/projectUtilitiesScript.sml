...
(******************************************************************************)
val getSquadLeaderCOM_def = Define `
(getSquadLeaderCOM ([]:commands option list) = (NONE:commands option))
 /\
(getSquadLeaderCOM (( SOME (SquadLeaderCOM cmd))::xs) = 
   ( SOME (SquadLeaderCOM cmd)))
 /\
(getSquadLeaderCOM (_::xs) = getSquadLeaderCOM xs)`
...
(******************************************************************************)
val getSquadLeaderCOMx_def = Define `
(getSquadLeaderCOMx ([]:(commands option,principal,'d,'e)Form list) = NONE)
 /\
(getSquadLeaderCOMx (((Name SquadLeader) says (prop (SOME (SquadLeaderCOM cmd))))::xs) = 
   (SOME (SquadLeaderCOM cmd:commands)))
 /\
(getSquadLeaderCOMx (_::xs) = getSquadLeaderCOMx xs)`

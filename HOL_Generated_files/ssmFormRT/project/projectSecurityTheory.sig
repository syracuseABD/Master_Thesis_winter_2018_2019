...
(*
      ...
      |- authentication =
         WFREC (@R. WF R)
           (λauthentication a.
              ...
              | Name SquadLeader says prop (SOME (SquadLeaderCOM x)) => I T
              | Name Omni says prop (SOME (SquadLeaderCOM x)) => I F
              | Name SquadLeader says prop (SOME (OmniCOM x')) => I F
   ...
   [stateAuth_def]  Definition
      ...
      |- ∀s x.
           ...
           if s = RT_FORM then
             ...
             if getSquadLeaderCOMx x = SOME (SquadLeaderCOM rtOrient) then
               [Name SquadLeader controls
                prop (SOME (SquadLeaderCOM rtOrient))]
             else [prop NONE]
           else if s = RT_ORIENT then
             if getSquadLeaderCOMx x = SOME (SquadLeaderCOM rtAlert) then
               [Name SquadLeader controls
                prop (SOME (SquadLeaderCOM rtAlert))]
             else [prop NONE]
           else if s = RT_ALERT then
             if getSquadLeaderCOMx x = SOME (SquadLeaderCOM complete) then
               [Name SquadLeader controls
   ...
   [authentication_def]  Theorem
      ...
      |- (authentication
            (Name SquadLeader says prop (SOME (SquadLeaderCOM x'))) ⇔ T) ∧
         ...
         (authentication
            (Name Omni says prop (SOME (SquadLeaderCOM v144))) ⇔ F) ∧
         (authentication
            (Name SquadLeader says prop (SOME (OmniCOM v145))) ⇔ F) ∧
   ...
   [authentication_ind]  Theorem
      ...
      |- ∀P.
           (∀x. P (Name SquadLeader says prop (SOME (SquadLeaderCOM x)))) ∧
           ...
           (∀v144. P (Name Omni says prop (SOME (SquadLeaderCOM v144)))) ∧
           (∀v145. P (Name SquadLeader says prop (SOME (OmniCOM v145)))) ∧
